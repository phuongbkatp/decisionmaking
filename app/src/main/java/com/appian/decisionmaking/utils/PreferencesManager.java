package com.appian.decisionmaking.utils;
...
public class PreferencesManager {
    ...
    private static final String PREFS_KEY = "com.appian.decisionmaking";
    private static final String STUDENT_LISTS_KEY = "com.appian.decisionmaking.studentLists";
